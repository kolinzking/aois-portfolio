...
- Autonomy modes: [notes.md](notes.md)
- Runtime control simulation: [lab.md](lab.md)
...
- Bridge to v24: [next-version-bridge.md](next-version-bridge.md)

## Self-Paced Path

1. Inspect `agentic/aois-p/runtime-autonomy-control.plan.json`.
2. Run the validator.
3. Run the simulator.

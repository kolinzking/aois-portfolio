...
Create `scripts/sysinfo.sh` and `scripts/log_analyzer.sh` exactly as shown in `03-notes.md`, make them executable, and run them.
...
- Previous: [v0.2 - Bash Scripting And First Automation](03-notes.md)
- Next: [v0.2 Runbook](05-runbook.md)
<!-- AOIS-NAV-END -->
